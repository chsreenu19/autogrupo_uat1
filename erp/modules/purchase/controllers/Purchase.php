...
/**
    ...
    /*
    public function abl_it_to_get_id($id) {        
        //load the warehouse model        
        $this->load->model('warehouse/warehouse_model');
        $data['commodites'] = $this->warehouse_model->able_it_get_commodity($id);
        // echo "<pre>";print_r($data['commodites']);exit;
        $data['newitems'] = $data['commodites'];
        $data['currency'] = 1;
        ...
        $order_date =  _d(date('Y-m-d'));
        $data['order_date'] = $order_date;
        $delivery_date = '' ;
        $data['delivery_date'] = $delivery_date;
        $data['term'] = null;
        $data['vendornote'] = null;
        // $data['estimate'] = 0;
        $data['days_owed'] = 1;
        $data['vendor'] = 1;
        ...
        $data['dc_total'] = $data['commodites'][0]['purchase_price'];
        $data['total_mn'] = $data['commodites'][0]['purchase_price'];
        $data['grand_total'] =  $data['commodites'][0]['purchase_price'];
        $data['pur_order_name'] = isset($data['commodites'][0]['commodity_name'])?$data['commodites'][0]['commodity_name'] :'';
        $data['total_tax'] = $data['commodites'][0]['purchase_price'];
    ...
    */
    ...
    public function abl_it_to_get_id1($id) {        
        //load the warehouse model        
        $this->load->model('warehouse/warehouse_model');
        $data['newitems'] = $this->warehouse_model->able_it_get_commodity($id);
        // echo "<pre>";print_r($data['newitems']);exit;
        // $data['newitems'] = $data['commodites'];
        ...
        $data['pur_order_name'] = isset($data['newitems'][0]['commodity_name'])?$data['newitems'][0]['commodity_name'] :'';     
        $data['pur_order_number'] = $pur_order_number;
