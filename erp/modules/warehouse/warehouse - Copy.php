...
$itemupload_dir = WAREHOUSE_MODULE_UPLOAD_FOLDER.'/item_img/'.DYNAMIC_DB.'/'; 
//echo $itemupload_dir; exit;
if ( !is_dir( WAREHOUSE_MODULE_UPLOAD_FOLDER.'/item_img/'.DYNAMIC_DB.'/' ) ) {
	//echo 'here'; exit;
		mkdir( WAREHOUSE_MODULE_UPLOAD_FOLDER.'/item_img/'.DYNAMIC_DB.'/' );       
}
define('WAREHOUSE_ITEM_UPLOAD', module_dir_path(WAREHOUSE_MODULE_NAME, 'uploads/item_img/'.DYNAMIC_DB.'/'));
