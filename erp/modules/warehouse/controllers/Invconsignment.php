 ...
 * warehouse controler
 */
class Invconsignment extends AdminController {
	...
	public function table_commodity_list() {
		$this->app->get_table_data(module_views_path('warehouse', 'ablereports/consignment/table_commodity_list'));
	}
	...
	public function commodity_list($id = '') {
		...
		$data['title'] = 'Consignment Stock';

		$data['proposal_id'] = $id;

		$this->load->view('ablereports/consignment/commodity_list', $data);
	}
