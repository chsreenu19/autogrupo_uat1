 ...
 * warehouse controler
 */
class Invsold extends AdminController {
	...
	public function table_commodity_list() {
		$this->app->get_table_data(module_views_path('warehouse', 'ablereports/sold/table_commodity_list'));
	}
	...
	public function commodity_list($id = '') {
		...
		$data['title'] = 'Inventory Sold';

		$data['proposal_id'] = $id;

		$this->load->view('ablereports/sold/commodity_list', $data);
	}
