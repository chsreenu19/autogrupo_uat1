               ...
               <div class="panel-body">
                <?php echo form_hidden('proposal_id',$proposal_id); ?>
                  ...
                  <div class="row row-margin-bottom">
                    ...
                    <div class="col-md-2" > 
                            <a class="btn btn-primary pull-left display-block new-proposal-btn" href="<?php echo base_url().'admin/warehouse/invsold/commodity_list'; ?>">Reset</a>
                        </div>
...
$(document).ready(function(){
  ...
  tinyMCE.init({
    ...
    var _table_api = initDataTable(table_commodity_list, admin_url+'warehouse/invsold/table_commodity_list', [0], [0], ProposalServerParams,  [1, 'desc']);
...
.table-table_commodity_list thead th:nth-child(9){
    min-width: 150px !important;
}
.table-table_commodity_list thead th:nth-child(8){
