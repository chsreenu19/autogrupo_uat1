                ...
                <?php echo form_hidden('proposal_id',$proposal_id); ?>
                  ...
                  <div class="row row-margin-bottom">
                    <div class="col-md-4 ">
						...
						<button class="btn btn-info pull-left display-block mr-4 button-margin-r-b syncall" onclick="syncall('<?php echo base_url().'admin/warehouse/syncitems/all' ?>')" id="all">Sync All</button>
                    ...
                    <!--<div class=" col-md-2">
                      <select name="all_groups" id="all_groups" class="selectpicker"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('Groups'); ?>">
                          <option value="">All Groups</option>
                           <?php foreach($all_groups as $item_f) { 
                            $selected = '';
                            if($item_f['id']==1 || $item_f['id'] =='1'){
                              $selected = "selected='selected'";
                            }
                      ...
                      <div class="form-group">
                        <select name="commodity_filter[]" id="commodity_filter" class="selectpicker" data-live-search="true" multiple="true" data-width="100%" data-none-selected-text="<?php echo _l('commodity_filter'); ?>">
                            ...
                            <?php foreach($commodity_filter as $commodity) { ?>
                              <option value="<?php echo html_entity_decode($commodity['id']); ?>"><?php echo '('.$commodity['sku_code'].')'.html_entity_decode($commodity['description']); ?></option>
                              <?php } ?>
                          </select>
                        </div>
                    </div>
                            ...
                            <div class="row">
								...
								<div class="col-md-2">
                                    ...
                                    $attr = ['data-type' => 'currency','readonly'=>'readonly'];
                                     echo render_input('commission_pack', 'Commission Pack','', 'text', $attr); ?>
								...
								<div class="col-md-2">
                                     ...
                                     echo render_select('purchase_gl_account',$able_coa_accounts,array('id','name','account_type_name'),'Purchase GL');
								...
								<div class="col-md-2">
                                    ...
                                    //$attr = ['class'=>'datepicker'];
                                     echo render_date_input('purchase_date', 'Purchase Date','', 'text', $attr); ?>
								...
								<div class="col-md-2">                                     
                                     <?php 
                                    $attr = array();
                                    echo render_select('sale_gl_account',$able_coa_accounts,array('id','name','account_type_name'),'Sale GL');
                                     ?>
                                </div>
                            </div>
