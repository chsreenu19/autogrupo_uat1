...
<div id="wrapper">
 ...
 <div class="pull-right"><button class="btn btn-info pull-left display-block mr-4 button-margin-r-b syncall pull-right" onclick="syncall('<?php echo base_url().'admin/warehouse/syncitems/'.$commodity_item->id ?>')" id="all">Sync</button>	</div>				
                         ...
                         <div class="row col-md-12">
                            ...
                            <div class="gallery">
                                <div class="wrapper-masonry">
                                  <div id="masonry" class="masonry-layout columns-3" style="max-height:300px; overflow:auto;">
                                <?php if(isset($commodity_file) && count($commodity_file) > 0){ ?>
                                  <?php foreach ($commodity_file as $key => $value) { ?>

										 <!--<a  class="images_w_table" href="<?php echo $value["file_name"]; ?>"><img class="images_w_table" src="<?php echo $value["file_name"]; ?>" alt="<?php //echo html_entity_decode($value['file_name']) ?>"/></a>-->
                            ...
                            <table class="table border table-striped table-margintop" >
                                <tbody>
                                   ...
                                   <tr class="project-overview">
                                    ...
                                    <tr class="project-overview">
                                      <td class="bold"><?php echo 'Sales Price'; ?></td>
                                   ...
                                   <tr class="project-overview">
                                     ...
                                     <tr class="project-overview">
										...
										if($commodity_item->addexpense==1){
											$price = $commodity_item->purchase_price + $expensesTotal;
										?>
										<td><span id="purprice"><?php echo app_format_money((float)$price,'') ; ?></span></td>
										<?php 
										}else{ ?>
                                        <td><span id="purprice"><?php echo app_format_money((float)$commodity_item->purchase_price,'') ; ?></span></td>
										<?php } ?>
                                     </tr>
                                     ...
                                     <td colspan="2">
                                        <div class="horizontal-scrollable-tabs preview-tabs-top">
                                            ...
                                            <div class="horizontal-tabs">
                                              <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                                                  ...
                                                  <li role="presentation">
												   ...
												   <li role="presentation">
                                                     <a href="#veh_expenses" aria-controls="veh_expenses" role="tab" id="tab_veh_expenses" data-toggle="tab">
                                          ...
                                          <div class="tab-content col-md-12">
											...
											<div role="tabpanel" class="tab-pane row" id="veh_expenses">
												...
												<div class="checkbox"><input <?php echo $checked;?> class="expckb" id="<?php echo $commodity_item->id;?>" type="checkbox" value="1" onchange="updateitemselect(<?php echo $commodity_item->id ?>, <?php echo $expensesTotal; ?>,<?php echo $commodity_item->purchase_price; ?>);"><label>Add expenses to Purchase price</label> <strong>$ <?php echo number_format($expensesTotal) ; ?></strong></div>
												
												</div>
												<table class="table dataTable no-footer exptbs">
												<thead>
													<tr>
														<th>Name</th>
														<th>Amount</th>
												...
												?>
													<tr>
                                       <td><?php echo '<a target="blank" href="' . admin_url('expenses/list_expenses/' . $exp['id']) . '" ">' . $exp['expense_name'] . '</a>'; ?></td>
														
														<td><?php echo ($exp['amount']!='') ? '$'.$exp['amount']: '$0.00'; ?></td>
														<td><?php echo $exp['ExppenseCategory']; ?></td>
														<!--<td><?php echo '<a href="' . site_url('download/file/expense/' . $exp['id']) . '">' . $exp['file_name'] . '</a>'; ?></td>-->
														<td><?php echo date("m/d/Y",strtotime($exp['date'])); ?></td>
														<!--<td><?php echo $exp['ProjectName']; ?></td>
														<td><?php echo $exp['ClientCompany']; ?></td>
														<td><?php echo $exp['invoiceid']; ?></td>
														<td><?php echo $exp['reference_no']; ?></td>
														<td><?php echo $exp['paymentmode']; ?></td>-->
...
<?php require 'modules/warehouse/assets/js/able_js.php';?>
<script>
$(document).ready(function(){
  ...
  tinyMCE.init({
    ...
    if (window.location.href.indexOf("veh_expenses") > -1) {
      $('html, body').animate({
         scrollTop: $("#tab_veh_expenses").offset().top
      }, 2000);
      $("#tab_veh_expenses").click()
