...
//eSignature forms
$volantForms = array(
    ['name'=>'A Liquidate Accounts','link'=>'aliquidateaccounts'],
    //['name'=>'Tradein Transfer and Collection','link'=>'tradeinatransferandcollection'],
    ['name'=>'Relay Responsibillity','link'=>'relayresponsibility'],
    ['name'=>'Premium return not earned','link'=>'premiumreturnnotearned'],
    ['name'=>'Promissory Sheet','link'=>'promissorysheet'],
    ['name'=>'Tradein Sheet','link'=>'tradeinsheet'],
    ['name'=>'Vehicle Warranties','link'=>'vehiclewarranties'],
    ['name'=>'We Owe','link'=>'salinas'],
    ['name'=>'Delivery Agreement','link'=>'deliveryagreement'],
    ['name'=>'Annex Purchase Order','link'=>'annexpurchaseorder']
);
define('IS_ESIGN_ENABLED',true);
define('ESIGN_FORM_NAMES', json_encode($volantForms));
