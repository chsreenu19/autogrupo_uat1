...
function app_init_admin_sidebar_menu_items()
{
	...
	$CI->app_menu->add_sidebar_menu_item('creditapplication', [
        'name'     => _l('Credit Application'),
        'href'     => admin_url('creditapplication/client/1	'),
        'position' => 1,
        'icon'     => 'fa fa-home',
        'badge'    => [],
    ]);
    ...
    if (has_permission('reports', '', 'view')) {
		...
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'commissionsreport',
            'name'     => _l('Commissions'),
            'href'     => admin_url('commissionsreport'),
            'position' => 30,
            'badge'    => [],
        ]);
		...
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'salesreport',
            'name'     => _l('VAP Report'),
            'href'     => admin_url('salesreport'),
            'position' => 30,
            'badge'    => [],
        ]);
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'invforsale',
            'name'     => _l('Available Stock'),
            'href'     => admin_url('warehouse/invforsale/commodity_list'),
            'position' => 30,
            'badge'    => [],
        ]);
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'invsold',
            'name'     => _l('Stock Sold'),
            'href'     => admin_url('warehouse/invsold/commodity_list'),
            'position' => 30,
            'badge'    => [],
        ]);
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'invconsignment',
            'name'     => _l('Consignment Stock'),
            'href'     => admin_url('warehouse/invconsignment/commodity_list'),
            'position' => 30,
            'badge'    => [],
        ]);
    }
