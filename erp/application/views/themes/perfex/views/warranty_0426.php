...
<div id="proposal-wrapper">
	  ...
	  <?php
	  //echo "<pre>"; print_r($itmdata['iattributes']['VIN']); exit;
   ...
   <div class="row" id="section-to-print">
      <div class="col-md-12 proposal-left">
         <div class="panel_s mtop20">
			...
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="<?php echo $int; ?>" type="text"/></div><label>Millage</label></div>
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="" type="text"/></div><label>Tablilla</label></div>
