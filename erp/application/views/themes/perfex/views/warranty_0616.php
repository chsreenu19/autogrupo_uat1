   ...
   <div class="row" id="section-to-print">
      <div class="col-md-12 proposal-left">
         <div class="panel_s mtop20">
			...
			<div class="col-md-3 col-xs-3"><h3>Precio:</br><strong><input style="font-size:21px;" class="inputbox form-control" value="<?php echo '$'.number_format($itmdata['rate']); ?>" type="text"/><?php //echo '$'.number_format($itmdata['rate']); ?></strong></h3></div>
			</div>
			<hr/>
