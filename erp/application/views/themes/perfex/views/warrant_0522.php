   ...
   <div class="row" id="section-to-print">
      <div class="col-md-12 proposal-left">
         <div class="panel_s mtop20">
			...
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="<?php echo $itmdata['iattributes']['Brand']; ?>" type="text"/></div><label>Marca</label></div>
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="<?php echo $itmdata['iattributes']['Model']; ?>" type="text"/></div><label>Modelo</label></div>
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="<?php echo $itmdata['iattributes']['Year']; ?>" type="text"/></div><label>Año</label></div>
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="<?php echo $itmdata['iattributes']['VIN']?>" type="text"/></div><label>Numero de serie</label></div>
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="<?php echo $itmdata['qty'];?>" type="text"/></div><label>Numero de inventario</label></div>
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control mil" value="<?php echo $int; ?>" type="text"/></div><label>Millage</label></div>
			<div class="col-md-3"><div class="form-group"><input class="inputbox form-control" value="<?php echo isset($itmdata['iattributes']['Tablilla'])?$itmdata['iattributes']['Tablilla']:'';?>" type="text"/></div><label>Tablilla</label></div>
			<div class="col-md-3"><h3>Precio:</br><strong><?php echo '$'.number_format($itmdata['rate']); ?></strong></h3></div>
			</div>
			<hr/>
	...
	<tbody>
		...
		<tr>
			...
			<div class="col-md-7"><strong style="font-size:12.0pt">FIRMA DEL COMPRADOR:</strong><input style="width: 60%;" class="inputbox" type="text"/></div>
			<div class="col-md-5"><strong style="font-size:12.0pt">FECHA:</strong><input class="inputbox" style="width: 60%;"  type="text"/></div>
			</div>
