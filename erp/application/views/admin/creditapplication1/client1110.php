         ...
         <div class="col-md-12">
            <?php if(isset($client) && $client->registration_confirmed == 0 && is_admin()){ ?>
               <div class="alert alert-warning">
                  ...
                  <br />
                  <a href="<?php echo admin_url('creditapplication/confirm_registration/'.$client->userid); ?>"><?php echo _l('confirm_registration'); ?></a>
               </div>
            <?php } else if(isset($client) && $client->active == 0 && $client->registration_confirmed == 1){ ?>
            <div class="alert alert-warning">
               <?php echo _l('customer_inactive_message'); ?>
               <br />
               <a href="<?php echo admin_url('creditapplication/mark_as_active/'.$client->userid); ?>"><?php echo _l('mark_as_active'); ?></a>
            </div>
            <?php } ?>
                  ...
                  <h4 class="bold">
                     ...
                     <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                           <?php if(is_admin()){ ?>
                           <li>
                              <a href="<?php echo admin_url('creditapplication/login_as_client/'.$client->userid); ?>" target="_blank">
               ...
               <div class="panel-body">
                  ...
                  <div>
                     <div class="tab-content">
                           <?php $this->load->view((isset($tab) ? $tab['view'] : 'admin/creditapplication/groups/profile')); ?>
                     </div>
                  </div>
               </div>
            </div>
