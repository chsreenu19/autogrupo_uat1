...
<style type="text/css">
  ...
  table.bordernone_pdf.table>tbody>tr>td {
    border-top: 0;
  }
  @media print {
    @page {
    ...
    <div class="container-fluid p-4 ">
      <div class="rowbs1">
        ...
        <div class="col-md-7 col-sm-7">
          <h3 class="pl-5 text-end ms-auto">Individual Customer Information First Leasing</h3>
        ...
        <div class="card-body">
          <table class="table border table-bordered">
            ...
            <tr>
              ...
              <td>
                <div class="form-group">
                  <label class="d-block w-100">Insurance</label>
                  <!-- <input type="text" class="form-control border" name=""> -->
          ...
          <table class="table border table-bordered">
            ...
            <tr>
              ...
              <td colspan="3" class="p-0 col-md-6">
                <!-- <table class="table mb-0 bordernone_pdf">
                  <tr>
                    <td> -->
                <div class="form-group mb-2">
