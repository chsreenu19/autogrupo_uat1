...
$aColumns = [
    ...
    'reference_no',
    'paymentmode',
	db_prefix() . 'items.description as item_select',
	'item_select as invid',
];
$join = [
...
foreach ($rResult as $aRow) {
	...
	$row[] = '<a target="blank" href="' . admin_url('warehouse/view_commodity_detail/' . $aRow['invid']) . '">' . $aRow['item_select'] . '</a>';//$aRow['item_select'];
