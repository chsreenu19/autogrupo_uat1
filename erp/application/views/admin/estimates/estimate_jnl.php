    ...
    <div class="modal-content data">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    Journal Entries, Only 10 Journal Entries are allowed
                </h4>
            </div>
        ...
        <div class="row centered-form">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="panel panel-info">
                    ...
                    <p class="text-center"><i class="fa fa-exclamation-triangle" aria-hidden="true" style="color:orange;"></i>
The following journal entries will be posted to accounting after the invoice is generated.</p>
                                        ...
                                        <div class="form-group">
                                            <?php 
                                                ...
                                                if(is_array($jnlsdetails['jnlvin']) && count($jnlsdetails['jnlvin'])>0){
                                                   ...
                                                   if($i==0){
                                                    echo render_select('vindecarro[]',$jnlsdetails['jnlvin'],array('vin','vin'), 'VIN de Carro', $selected);
                                                   }else{
                                        ...
                                        <div class="form-group">
                                            <?php 
                                                ...
                                                if(is_array($jnlsdetails['jnllead']) && count($jnlsdetails['jnllead'])>0){
                                                   ...
                                                   if($i==0){
                                                    echo render_select('customernumber[]',$jnlsdetails['jnllead'],array('id','name','phonenumber'), 'Customer Number', $selected);
                                                   }else{
