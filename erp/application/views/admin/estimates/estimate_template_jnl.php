...
<div class="btn-bottom-toolbar bottom-transaction text-right sm:tw-flex sm:tw-items-center sm:tw-justify-between">
...
?>
        <button type="button"
            class="btn btn-warning mleft10 jrbutton">
            <?php echo _l('Journal Entries'); ?>
        </button>
