...
<div class="panel-body">
    <div class="row">
        <div class="col-md-4">
            <?php 
                if($userroleid!=FI_ROLE_ID){
                    $this->load->view('admin/invoice_items/item_select'); 
                }
            ...
            <tbody>
                ...
                <?php if (isset($estimate) || isset($add_items)) {
                         ...
                         foreach ($add_items as $item) {
                             ...
                             $table_row .= '</td>';
                             $table_row .= '<td class="bold description"><textarea '.$roAttr.' name="' . $items_indicator . '[' . $i . '][description]" class="form-control" rows="5">' . clear_textarea_breaks($item['description']) . '</textarea></td>';
                             $table_row .= '<td><textarea '.$roAttr.' name="' . $items_indicator . '[' . $i . '][long_description]" class="form-control" rows="5">' . clear_textarea_breaks($item['long_description']) . '</textarea></td>';
                             //$table_row .= render_custom_fields_items_table_in($item, $items_indicator . '[' . $i . ']');
                             $table_row .= '<td><input '.$roAttr.' type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="' . $items_indicator . '[' . $i . '][qty]" value="' . $item['qty'] . '" class="form-control">';
                             $unit_placeholder = '';
                             if (!$item['unit']) {
                             ...
                             $table_row .= '</td>';
                             $table_row .= '<td class="rate"><input '.$roAttr.' type="number" data-toggle="tooltip" title="' . _l('numbers_not_formatted_while_editing') . '" onblur="calculate_total();" onchange="calculate_total();" name="' . $items_indicator . '[' . $i . '][rate]" value="' . $item['rate'] . '" class="form-control"></td>';
