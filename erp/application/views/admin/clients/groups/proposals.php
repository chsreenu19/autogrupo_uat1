...
{ 
	if(isset($client->leadid) && $client->leadid!=''){
?>
	<a href="<?php echo admin_url('proposals/proposal?rel_type=lead&rel_id=' . $client->leadid); ?>"
...
<?php 
	...
	<a href="javascript:void(0);"
		class="btn btn-primary mbot15 disabled">
		<i class="fa-regular fa-plus tw-mr-1"></i>
		<?php echo _l('new_proposal'); ?>
	</a>
