                  ...
                  if (total_rows(db_prefix() . 'customfields', ['fieldto' => 'customers', 'active' => 1]) > 0) {
                    ...
                    <li role="presentation" class="<?php if ($this->input->get('tab') == 'custom_fields') {
                        ...
                        <a href="#custom_fields" aria-controls="custom_fields" role="tab" data-toggle="tab">
                            <?php echo hooks()->apply_filters('customer_profile_tab_custom_fields_text', 'Additional Details'); ?>
                        </a>
                    </li>
                    <?php
                  } ?>
        ...
        <div class="tab-content mtop15">
            ...
            <div role="tabpanel" class="tab-pane" id="customer_admins">
                ...
                <a href="#" data-toggle="modal" data-target="#customer_admins_assign"
                    class="btn btn-primary mbot30"><?php echo _l('Assign Sales Representative'); ?></a>
                <?php } ?>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
								...
								<span style="font-style:italic; font-size:10px;"> <i>Format: Urbanization, Condominium or Neighborhood, House number, Street, Mailbox, Muncipality, Postal zone </i></span>
                                <?php $value = (isset($client) ? $client->billing_street : ''); ?>
                                <?php echo render_textarea('billing_street', 'billing_street', $value, array('placeholder'=>'Urbanization, Condominium or Neighborhood, House number, Street, Mailbox, Muncipality, Postal zone')); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php echo render_textarea('shipping_street', 'shipping_street', $value, array('placeholder'=>'Urbanization, Condominium or Neighborhood, House number, Street, Mailbox, Muncipality, Postal zone')); ?>
