            ...
            foreach ($custom_fields as $field) {
				...
				?>
					...
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500 no-mtop">
						...
						?>
						<dd class="tw-text-neutral-900 tw-mt-1"><?php echo $value; ?></dd>
						<?php 
						}else{
						?>
        ...
        <div class="lead-edit<?php if (isset($lead)) {
          ...
          ?>
            ...
            $value = (isset($lead) ? $lead->phonenumber : ''); ?>
                <?php echo render_input('phonenumber', 'lead_add_edit_phonenumber', $value, 'input', array('data-custom-field-required'=>true)); ?>
                <div class="form-group">
