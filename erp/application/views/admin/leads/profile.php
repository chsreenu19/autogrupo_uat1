...
<div class="<?php if ($openEdit == true) {
    ...
    <?php 
    //To validate if Credit score is already filled or not.
    // echo "<pre>";print_r($ssnconsent); 
    if ($ssnconsent=='opt-in') {
    ?>
    <a style="margin-right:5px;" href="#" data-toggle="tooltip" data-title="<?php echo $convert_to_client_tooltip_email_exists; ?>"
        class="btn btn-info pull-right lead-top-btn lead-view"
        onclick="fetchcreditscore(<?php echo $lead->id; ?>,'<?php echo $lead->name; ?>'); return false;">
        <i class="fa-regular fa-user"></i>
          ...
          echo ' hide';
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('First Name'); ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 lead-name">
                        <?php echo(isset($lead) && $lead->name != '' ? $lead->name : '-') ?></dd>
						
				    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('Last Name'); ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 lead-name">
                        <?php echo(isset($lead) && $lead->last_name != '' ? $lead->last_name : '-') ?></dd>
            ...
            foreach ($custom_fields as $field) {
                $value = get_custom_field_value($lead->id, $field['id'], 'leads'); ?>
					...
					<?php 
					if($field['name']=='700Custom Report')	{
				?>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500 no-mtop">
                        <?php echo $field['name']; 
						...
						?></dt>
					<?php if($value!=''){?>
                    <!--<dd class="tw-text-neutral-900 tw-mt-1 700report">View Report</dd>-->
					<!--<a id="700Reportlink" target="blank" href="<?php echo base_url(); ?>admin/leads/creditreport/<?php echo $lead->id; ?>">View Report</a>-->
					<a id="700Reportlink" target="blank" href="<?php echo base_url(); ?>admin/leads/creditreport/<?php echo $lead->id; ?>">View Report</a>
					<?php } else{?>
					<dd class="tw-text-neutral-900 tw-mt-1">N/A</dd>
					
                    <?php }
				} elseif($field['name']=='Social Security Number'){ ?>
					...
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500 no-mtop">
						...
						?>
						<dd class="tw-text-neutral-900 tw-mt-1"><?php echo $number; ?></dd>
						<?php 
						}else{
						?>
						<dd class="tw-text-neutral-900 tw-mt-1"><?php echo '-'; ?></dd>
						<?php } ?>
        ...
        <div class="lead-edit<?php if (isset($lead)) {
          ...
          ?>
            ...
            <div class="col-md-6">
                ...
                <?php echo render_input('email', 'lead_add_edit_email', $value,'input', array('data-custom-field-required'=>true)); ?>
            ...
            $value = (isset($lead) ? $lead->phonenumber : ''); ?>
                <?php echo render_input('phonenumber', 'lead_add_edit_phonenumber', $value, 'input', array('data-custom-field-required'=>true,'placeholder'=>'(000)-000-0000')); ?>
                <div class="form-group">
            ...
            <div class="col-md-6">
				<?php $value = (isset($lead) ? $lead->last_name : ''); ?>
                <?php echo render_input('last_name', 'Last Name', $value, 'input', array('data-custom-field-required'=>true)); ?>
                <?php $value = (isset($lead) ? $lead->address : ''); ?>
                <?php echo render_textarea('address', 'lead_address', $value, ['rows' => 1, 'style' => 'height:36px;font-size:100%;', 'data-custom-field-required'=>true]); ?>
                <?php $value = (isset($lead) ? $lead->city : ''); ?>
                <?php echo render_input('city', 'lead_city', $value, 'input', array('data-custom-field-required'=>true)); ?>
                <?php $value = (isset($lead) ? $lead->state : ''); ?>
                <?php echo render_input('state', 'lead_state', $value, 'input', array('data-custom-field-required'=>true)); ?>
                <?php
               ...
               ?>
                ...
                <?php echo render_input('zip', 'lead_zip', $value, 'input', array('data-custom-field-required'=>true)); ?>
                <?php if (!is_language_disabled()) { ?>
                <div class="form-group">
...
$(document).ready(function(){
    ...
    if (number.length == 7 || number.length == 10) {
      $(this).val('(' + number.substring(0, 3) + ')-' + number.substring(3, 6) + '-' + number.substring(6));
    } else if (number.length > 10) {
      $(this).val('(' + number.substring(0, 3) + ')-' + number.substring(3, 6) + '-' + number.substring(6, 10));
    }
  });
