...
//alert(1);
	...
	$("<div class='row tohideifnottradein'><div class='col-md-12 text-center'><hr class=''/><h4>Trade In Details </h4></div></div>").insertAfter( $('form input[name="custom_fields[proposal][51]" ').closest(".col-md-2") );

	$("<div class='row tohideifnottradein'><div class='col-md-12 text-center'><hr class='tohideifnottradein'/><h4>VAP & Insurance</h4></div></div>").insertAfter( $('form input[name="custom_fields[proposal][61]" ').closest(".col-md-2") );
