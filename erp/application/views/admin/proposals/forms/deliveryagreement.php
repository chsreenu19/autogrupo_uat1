                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="paratext my-2">
                                        ...
                                        adquirí el vehículo de motor marca, <input type="text" class="inputbox inp3" value="<?php echo $make;?>"/>&nbsp; 
                                        modelo,&nbsp;
                                        <input type="text" class="inputbox inp3" value="<?php echo $model;?>"/>&nbsp;
                                        Año:,&nbsp;
                                        <input type="text" class="inputbox inp4" value="<?php echo $year;?>"/>&nbsp;
                                        y número de serie&nbsp;
                                        <input type="text" class="inputbox inp5" value="<?php echo $vin;?>"/>&nbsp;
