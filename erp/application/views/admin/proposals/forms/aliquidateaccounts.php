                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="txinptbk">
                                        ...
                                        <span> CON </span>
                                        <input type="text" class="txinpt aqinp3"  value="<?php echo $tbankpayoff?>"/>
                                ...
                                <div class="col-sm-12">
                                    <div class="input_sec LIQ_text mb-15">
                                        ...
                                        <input type="text" class="inputbox w-100" value="<?php echo $warehousecode; ?>">
                                    </div>
                                    <div class="input_sec STOCK_text mb-15">
                                        <label>STOCK:</label>
                                        <input type="text" class="inputbox w-100" value="<?php echo $tvin; ?>">
                                    </div>
                                    ...
                                    <div class="input_sec halfipt_text mb-15">
                                        ...
                                        <input type="text" class="inputbox" value="<?php echo $tvin; ?>">
                                    </div>
                                    <div class="input_sec halfipt_text mb-15">
                                    ...
                                    <div class="input_sec halfipt_text mb-15">
                                        ...
                                        <input type="text" class="inputbox" value="<?php echo $tmarbete;?>">
                                    </div>
