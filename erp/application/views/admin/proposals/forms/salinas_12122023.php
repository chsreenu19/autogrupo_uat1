                    ...
                    <div class="panel-body">
                        <div class="print_block" id="print_block">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <h3 class="main_head text-center my-3">    <?php echo strtoupper($companyname); ?></h3>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-6">
                                    <div class="inptxt my-2">
                                        <label>SUCURSAL DE:</label>
                                        <input type="text" class="inputbox inp1" value="<?php echo $warehousecode; ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="inptxt my-2">
                                        <label>VENDEDOR:</label>
                                        <input type="text" class="inputbox inp1" value="<?php echo $salesreplname.' '.$salesrepfname; ?>"/>
                                    </div>
                                </div>

                                <div class="col-xs-6">
                                    <div class="textchk mb-5">
                                        <label>
                                        ...
                                        <label>
                                            <input type="checkbox" name="">
                                            LICENCIA DE COMPRADOR
                                        </label>
                                        <label>
                                            <input type="checkbox" name="">
                                            SEGURO SOCIAL COMPRADOR
                                        </label>
                                        <label>
                                            <input type="checkbox" name="">
                                            LICENCIA DEL AUTO
                                ...
                                <div class="col-xs-6">
                                    <div class="textchk mb-5">
                                        ...
                                        <label>
                                            <input type="checkbox" name="">
                                            OTROS &nbsp;&nbsp; &nbsp;<input type="text" class="inputbox div2inp3 ml-4" />
                                        </label>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="inptxt ps-0 my-2">
                                        <label>ENVIADO POR</label>
                                        <input type="text" class="inputbox inp2" value="<?php echo $salesrepmanager; ?>"/>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="inptxt ps-0 my-2">
                                        <label>PARA:</label>
                                        <input type="text" class="inputbox inp2" value="<?php echo $salesreplname.' '. $salesrepfname; ?>"/>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="inptxt ps-0 my-2">
                                        <label>FECHA:</label>
                                        <input type="text" class="inputbox inp3" value="<?php echo $today;?>"/>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="inptxt ps-0 my-2">
...
<style>
    ...
    .textchk label input[type="checkbox"] {
        margin-right: 10px;
        width: 23px;
        height: 16px;
        margin-bottom: 9px;
