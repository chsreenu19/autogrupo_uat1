                        ...
                        <div
                            ...
                            <p class="no-mbot pull-left mtop5 btn-toolbar-notice tw-hidden sm:tw-block">
                                ...
                                <?php 
                                    ...
                                    if(isset($proposal) && $userrole->role==SUPER_ADMIN_ROLE_ID){
                                    ?>    
                                    <button type="button"
...
$(function() {
    ...
    $("body").on("click",".dealcalculatorbtn",function(){
        ...
        //dimond ceramic
		//alert('dimond#'+vaptotal+ '#####'+vapmargin);
        ...
        var vehmargin = parseFloat(vinprice) - parseFloat(vehmargin);
        var acvmargin = parseFloat(tradeinallowance) - parseFloat(acv);  
        $('#frontgross_value_price').text(parseFloat(acvmargin));
        ...
        $('#totalgross_value_price').text(parseFloat(tbackmargin));

        var fronmargincalc = (parseFloat(acvmargin) * 100 /parseFloat(vinprice)).toFixed(2);
        ...
        var ftotalmargin = (parseFloat(tbackmargin) * 100 /parseFloat(totalbalance)).toFixed(2);
