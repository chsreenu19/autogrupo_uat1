...
$(function() {
    ...
    $("body").on("click",".dealcalculatorbtn",function(){
		...
		//alert(vinprice+'====='+vehmargin+'========'+vehmargins);
		var acvmargin = parseFloat(tradeinallowance) - parseFloat(acv);  
		var fmargin = parseFloat(vehmargins).toFixed(2) - acvmargin
		...
		//var tgvp = parseFloat(tbackmargin) + fmargin;
		var tgvp = parseFloat(backgrossmargin) + fmargin;
		//alert(tgvp);
