...
$dob = isset($quotedata['main_data']['lead']['Date of Birth']) ? $quotedata['main_data']['lead']['Date of Birth'] : '';
		...
		<tbody>
			<tr>
				...
				<table style="border-color: #ffffff !important;" border="0" cellpadding="1" cellspacing="1">
					<tbody>
						<tr>
							<td style=" border-color: #ffffff !important;">Date of Sale: <input style="width: 50% !important;" type="text" placeholder="enter date of sale" value="<?php echo isset($quotedata['main_data']['quote']['date']) ? $quotedata['main_data']['quote']['date'] : ''; ?>"/></td>
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="2" style="text-align: right;"> <input placeholder="enter balance adeudado"  name="BALANCE_ADEUDADO" type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_balance']) ? $quotedata['main_data']['custom_feilds']['proposal_balance'] : ''; ?>"></td>
            </tr>
            <tr>
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            <tr>
              ...
              <td colspan="2" style="text-align: right;"><input value="<?php echo isset($quotedata['main_data']['inventory']['rate']) ? $quotedata['main_data']['inventory']['rate'] : ''; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2">Gap</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter gap" name="GAP " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_gap']) ? $quotedata['main_data']['custom_feilds']['proposal_gap'] : ''; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Seguro Doble</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter seguro doble" name="SEGURO_DOBLE " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_double_insurance']) ? $quotedata['main_data']['custom_feilds']['proposal_double_insurance'] : ''; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Seguro de Vida</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter seguro de vida" name="SEGURO_DE_VIDA " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_life_insurance']) ? $quotedata['main_data']['custom_feilds']['proposal_life_insurance'] : ''; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Contrato de servicio</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter contrato de servicio" name="CONTRATO_DE_SERVICIO " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_service_contract']) ? $quotedata['main_data']['custom_feilds']['proposal_service_contract'] : ''; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Tablillas</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter tabillas" name="TABLILLAS " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_tablillas']) ? $quotedata['main_data']['custom_feilds']['proposal_tablillas'] : ''; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Seguro ACAA</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter seguro acaa" name="SEGURO_ACAA " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_acaa_insurance']) ? $quotedata['main_data']['custom_feilds']['proposal_acaa_insurance'] : ''; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Precio Total</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter precio total" name="PRECIO_TOTAL " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_price_total']) ? $quotedata['main_data']['custom_feilds']['proposal_price_total'] : ''; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Credito Total</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter credit total" name="CREDITO_OTAL " type="text" value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_credit_total']) ? $quotedata['main_data']['custom_feilds']['proposal_credit_total'] : ''; ?>"></td>
            </tr>
            <tr>
