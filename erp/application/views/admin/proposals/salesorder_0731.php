...
$CreditoporCarroUsado = isset($quotedata['main_data']['custom_feilds']['proposal_tradein']) ? $quotedata['main_data']['custom_feilds']['proposal_tradein'] : 0;
...
$PagodeContado = isset($quotedata['main_data']['custom_feilds']['proposal_down_payment']) ? $quotedata['main_data']['custom_feilds']['proposal_down_payment'] : 0;
      ...
      <div style="width: 45%; float:left;">
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
			...
			<tr>
              <td colspan="2">VA Product <input placeholder=""  name=" " type="text" value="" placeholder="$0.00"></td>
              <td colspan="2"><input placeholder=""  name="vaproduct" id="vaproduct" type="text" value="" placeholder="$0.00"></td>
            </tr>
            ...
            <tr>
              <td colspan="2">Gap</td>
              <td colspan="2" style="text-align: right;"><input placeholder="enter gap" name="GAP " type="text" value="$<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_gap_policy']) && $quotedata['main_data']['custom_feilds']['proposal_gap_policy']!='') ? $quotedata['main_data']['custom_feilds']['proposal_gap_policy'] : '$0.00'; ?>"></td>
            </tr>
            <tr>
