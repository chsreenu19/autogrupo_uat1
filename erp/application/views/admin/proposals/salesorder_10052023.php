		...
		<tbody>
			<tr>
				<td style="border-color:#ffffff !important;">
					...
					<input style="width:80%;" type="text" value="<?php echo (isset($quotedata['main_data']['lead']['address']) ? $quotedata['main_data']['lead']['address'] : '') . ' ' .(isset($quotedata['main_data']['lead']['zip']) ? ', '.$quotedata['main_data']['lead']['zip'] : '') ; ?>"></br>
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="2">Vence: <input value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_pending_balance_pay_off_balance']) ? $quotedata['main_data']['custom_feilds']['proposal_pending_balance_pay_off_balance'] : ''; ?>" type="text" style="width:88%" placeholder="enter vence"/></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2" style="text-align: right;"> <input placeholder="enter credito por carro usado"  name="CREDITO_POR_CARRO_USADO" type="text" value="<?php echo (isset($CreditoporCarroUsado) && $CreditoporCarroUsado!='') ? '$'.number_format($CreditoporCarroUsado) : '$0.00'; ?>"></td>
            </tr>
            <tr>
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            <tr>
              ...
              <td colspan="2" class="input-bold" style="text-align: right;"><input value="<?php echo isset($quotedata['main_data']['inventory']['invqprice']) ? '$'.number_format($quotedata['main_data']['inventory']['invqprice']) : '$0'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
            </tr>
