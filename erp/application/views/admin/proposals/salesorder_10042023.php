		...
		<tbody>
			<tr>
				<td style="border-color:#ffffff !important;">
					...
					<input style="width:80%;" type="text" value=""></br>
				</td>
				<td style="background-color:#ffffff; border-color:#ffffff; width:40%; text-align:right;">
      ...
      <div style="width: 55%; float: left;">
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="4">Balance Adeudado A:<input value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_balance']) ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_balance']) : ''; ?>" type="text" style="width:88%" placeholder="enter balance"/></td>
            </tr>
            <tr>
