...
$SoTotalVAP = $SoPowerPack + $SoRoadAssistance + $SoServiceContract + $SoPaymentProtection + $SoDimondCeramic;
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
			...
			<tr>
			  ...
			  <input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_tradein']) && $quotedata['main_data']['custom_feilds']['proposal_tradein']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_tradein']) : '$0'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text">
