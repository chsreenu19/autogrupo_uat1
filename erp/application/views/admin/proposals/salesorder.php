...
//$postalAddress = isset($quotedata['main_data']['lead']['Postal Address']) ? $quotedata['main_data']['lead']['Postal Address'] : '';
$postalAddress = (isset($quotedata['main_data']['lead']['Postal Address']) && $quotedata['main_data']['lead']['Postal Address']!='') ? $quotedata['main_data']['lead']['Postal Address'] : $caddress;

if($firstPaymentDate!=0){
	$firstPaymentDate = date('m-d-Y',strtotime($firstPaymentDate));
}

if($secondPaymentDate!=0){
	$secondPaymentDate = date('m-d-Y',strtotime($secondPaymentDate));
}
...
$BalanceAdeudado = (isset($quotedata['main_data']['custom_feilds']['proposal_due']) && $quotedata['main_data']['custom_feilds']['proposal_due']!='') ? $quotedata['main_data']['custom_feilds']['proposal_due'] : '0.00';
...
$PagodeContado = (isset($quotedata['main_data']['custom_feilds']['proposal_down_payment']) && $quotedata['main_data']['custom_feilds']['proposal_down_payment']!='') ? $quotedata['main_data']['custom_feilds']['proposal_down_payment'] : '0.00';
...
$vehicleRate = isset($quotedata['main_data']['inventory']['invqprice']) ? $quotedata['main_data']['inventory']['invqprice'] : '0';
...
//echo 'vehicle rate '. $vehicleRate.'<br/>';
//echo 'Tradein:'.$soTradeIn.'<br/>';
//echo 'Downpayment:'.$SodownPayment.'<br/>';
//echo $SoTradeIn; exit;
//$SoTradeIn = $CreditoporCarroUsado;
...
//echo $SoBalanceAfterCredit; exit;
			...
			<tr>
				...
				<!--<td style="background-color:#ffffff; border-color:#ffffff; width:40%; text-align:right;">
					...
					<!--Fax: ------------</br>
					 ...
					 <td style="background-color:#ffffff; border-color:#ffffff; width:40%; text-align:right;">
					<?php echo get_option('invoice_company_name') ?>&nbsp;</br>
					<?php echo get_option('invoice_company_name').', '.get_option('invoice_company_address'); ?>&nbsp;</br>
          <?php echo get_option('invoice_company_city').', '.get_option('company_state').', '.get_option('invoice_company_country_code').', '.get_option('invoice_company_postal_code') ?></br>
					Tel: <?php echo get_option('invoice_company_phonenumber'); ?></br>
		...
		<tbody>
			<tr>
				<td style="border-color:#ffffff !important;">
					...
					<input style="width:80%;" type="text" value="<?php echo (isset($quotedata['main_data']['lead']['address']) ? $quotedata['main_data']['lead']['address'] : '') .' '. (isset($quotedata['main_data']['lead']['city']) ? $quotedata['main_data']['lead']['city'] : '').' '. (isset($quotedata['main_data']['lead']['state']) ? $quotedata['main_data']['lead']['state'] : '') . ' ' .(isset($quotedata['main_data']['lead']['zip']) ? ', '.$quotedata['main_data']['lead']['zip'] : '') ; ?>"></br>
					<span style="font-weight: bold">Direccion Postal</span></br>
					<input style="width:80%;" type="text" value="<?php echo $postalAddress; ?>"></br>
				</td>
				<td style="background-color:#ffffff; border-color:#ffffff; width:40%; text-align:right;">
				<table style="border-color: #ffffff !important;" border="0" cellpadding="1" cellspacing="1">
					<tbody>
						...
						<tr>
							<td style=" border-color: #ffffff !important;">Email: <input style="width: 80% !important;" type="text" placeholder="enter email" value="<?php echo isset($quotedata['main_data']['lead']['email']) ? strtolower($quotedata['main_data']['lead']['email']) : ''; ?>"/></td>
      ...
      <div style="width: 55%; float: left;">
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Marbete:<input type="text" style="width:88%" placeholder="enter marbete" value="<?php echo isset($quotedata['main_data']['inventory']['Marbete']) ? $quotedata['main_data']['inventory']['Marbete'] : ''; ?>"/></td>
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2">Millaje: <input value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_millaje']) ? $quotedata['main_data']['custom_feilds']['proposal_millaje'] : ''; ?>" type="text" style="width:88%" placeholder="enter millaje"/></td>
            ...
            <tr>
              <td colspan="4">Balance Adeudado A:<input value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_bank_financing_institution']) ? $quotedata['main_data']['custom_feilds']['proposal_bank_financing_institution'] : ''; ?>" type="text" style="width:88%" placeholder="enter balance"/></td>
            </tr>
            <tr>
              ...
              <td colspan="2">Vence: <input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_marbete_vence']) && $quotedata['main_data']['custom_feilds']['proposal_marbete_vence']!='') ? date("m-d-Y",strtotime($quotedata['main_data']['custom_feilds']['proposal_marbete_vence'])) : ''; ?>" type="text" style="width:88%" placeholder="enter vence"/></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2" style="text-align: right;"> <input placeholder="enter credito por carro usado"  name="CREDITO_POR_CARRO_USADO" type="text" value="<?php echo (isset($CreditoporCarroUsado) && $CreditoporCarroUsado!='') ? '$'.number_format($CreditoporCarroUsado,2) : '$0.00'; ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Balance Adeudado </td>
              <td colspan="2" style="text-align: right;"> <input placeholder="enter balance adeudado"  name="BALANCE_ADEUDADO" type="text" value="$<?php echo number_format($BalanceAdeudado,2); ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Credito Neto</td>
              <td colspan="2" style="text-align: right;"> <input placeholder="enter credito neto"  name="CREDITO_NETO" type="text" value="$<?php echo number_format($creditNeto,2); ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Pago de Contado</td>
              <td colspan="2" style="text-align: right;"> <input placeholder="enter pago de contado"  name="PAGO_DE_CONTADO" type="text" value="$<?php echo number_format($PagodeContado,2); ?>"></td>
            </tr>
            <tr>
              <td colspan="2">Credito a su favor </td>
              <td colspan="2" style="text-align: right;"> <input placeholder="enter credito a su favor" name="CREDITO_A_SU_FAVOR " type="text" value="$<?php echo number_format($Creditoasufavor,2); ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2" style="text-align: right;"> <input placeholder="enter credit total"  name="CREDITO_TOTAL " type="text" value="$<?php echo number_format($CreditoTotal,2); ?>"></td>
            </tr>
            <tr>
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
            <tr>
              ...
              <td colspan="2" class="input-bold" style="text-align: right;"><input value="<?php echo isset($quotedata['main_data']['inventory']['invqprice']) ? '$'.number_format($quotedata['main_data']['inventory']['invqprice'],2) : '$0'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
            </tr>
			...
			<tr>
			  ...
			  <input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_down_payment']) && $quotedata['main_data']['custom_feilds']['proposal_down_payment']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_down_payment'],2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text">
			  ...
			  <input value="<?php echo '$'.number_format($SoTradeIn,2); ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text">
			  ...
			  <td colspan="2" style="text-align: right;">
			  <input value="<?php echo ($SoTotalCredit)>0 ? '$'. number_format($SoTotalCredit,2) : '$0.00'; ?>" placeholder="" name="PRECIO_UNIDAD" type="text"></td>
			  </tr>
			   <tr>
              <td colspan="2"><strong>Balance After Credits</strong></td>
              <td colspan="2" class="input-bold" style="text-align: right;"><input value="<?php echo ($SoBalanceAfterCredit)>0 ? '$'. number_format($SoBalanceAfterCredit,2) : '$0'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" ></td>
            </tr>
			<tr>
              <td colspan="2" style="padding-left:15px">
			  Power Pack
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_power_pack_2']) && $quotedata['main_data']['custom_feilds']['proposal_power_pack_2']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_power_pack_2'],2) : '$0.00';  ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text"></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  Road Assistance 
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_service_contract']) && $quotedata['main_data']['custom_feilds']['proposal_service_contract']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_service_contract'],2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" ></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  Service Contract
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_service_contract_policy_number']) && $quotedata['main_data']['custom_feilds']['proposal_service_contract_policy_number']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_service_contract_policy_number'],2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  Payment Protection
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_payment_plan']) && $quotedata['main_data']['custom_feilds']['proposal_payment_plan']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_payment_plan'],2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text"></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  Dimond Ceramic
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_credit_total_2']) && $quotedata['main_data']['custom_feilds']['proposal_credit_total_2']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_credit_total_2'],2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text"></td>
			  </tr>
			  
			  <td colspan="2" style="padding-left:15px">
			  Auto Secure <?php echo $autosecuretype; ?>
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo '$'.number_format($autosecure,2); ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text"></td>
			  </tr>
			  
			   <tr>
              <td colspan="2"><strong>Total VAP</strong></td>
              <td colspan="2" class="input-bold" style="text-align: right;"><input value="<?php echo ($SoTotalVAP)>0 ? '$'. number_format($SoTotalVAP,2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" ></td>
            </tr>
			<tr>
              <td colspan="2" style="padding-left:15px">
			 Insurance <?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_double_insurance']) && $quotedata['main_data']['custom_feilds']['proposal_double_insurance']!='') ? $quotedata['main_data']['custom_feilds']['proposal_double_insurance'] : ' '; ?>
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_insurance_policy']) && $quotedata['main_data']['custom_feilds']['proposal_insurance_policy']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_insurance_policy'],2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  GAP
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_gap_policy']) && $quotedata['main_data']['custom_feilds']['proposal_gap_policy']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_gap_policy'],2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			   <tr>
              <td colspan="2"><strong>Total Balance</strong></td>
              <td colspan="2" class="input-bold" style="text-align: right;font-weight:600;"><input value="<?php echo ($SoTotalBalance)>0 ? '$'. number_format($SoTotalBalance,2) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text"></td>
            </tr>
           <!-- <tr>
         ...
         <table style="width: 100%;">
          <tbody>
            ...
            <tr style="height:50px; vertical-align:bottom;">
			  ...
			  <?php 
			  $repName = '';
			  if(isset($quotedata['main_data']['quote']['assignedtofname']) && $quotedata['main_data']['quote']['assignedtofname']!=''){
			  
				$repName .= $quotedata['main_data']['quote']['assignedtofname'];
			  }
			  if(isset($quotedata['main_data']['quote']['assignedtolname']) && $quotedata['main_data']['quote']['assignedtolname']!=''){
			  
				$repName .= ', '.$quotedata['main_data']['quote']['assignedtolname'];
			  }
			  
			  ?>
              <td>FIRMA DEL VENDEDOR: <input style="width: 40% !important;" type="text" value="<?php echo $repName; ?>" ></td>
              <td>NUM. REF. <?php echo $quotedata['main_data']['quote']['id']; ?></td>
            </tr>
          </tbody>
		  </table>
