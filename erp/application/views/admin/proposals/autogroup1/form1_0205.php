...
$customername = ((isset($quotedata['main_data']['lead']['name'])) && $quotedata['main_data']['lead']['name'] != '') ? $quotedata['main_data']['lead']['name'] : '';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-xs-6 secondright px-0 br-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 col-xs-4 br-0">
                                                    <input id="qbalancepagar" type="text" class="inputbox olinp" value="<?php echo number_format($qpreciototal, 2); ?>"/>
                                                </div>
