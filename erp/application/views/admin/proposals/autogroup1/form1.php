...
$qitemprice = ((isset($quotedata['main_data']['inventory']['invqprice'])) && $quotedata['main_data']['inventory']['invqprice'] != '') ? $quotedata['main_data']['inventory']['invqprice'] : 0;
...
if($qfinancialinstitution =='First Bank'){
	$qbalanceapagartotal = ($qitemprice + $qroadassist + $qdimondceramic + $qpaymentprotection) - $credittotal;
}else{
...
//insurance
$insuranceType = ((isset($quotedata['main_data']['custom_feilds']['proposal_double_insurance'])) && $quotedata['main_data']['custom_feilds']['proposal_double_insurance'] != '') ? ' - '.strtoupper(strtolower( $quotedata['main_data']['custom_feilds']['proposal_double_insurance'])) : '';

$insuranceoptions = ((isset($quotedata['main_data']['custom_feilds']['proposal_insurance_options'])) && $quotedata['main_data']['custom_feilds']['proposal_insurance_options'] != '') ? strtoupper(strtolower( $quotedata['main_data']['custom_feilds']['proposal_insurance_options'])) : 'INSURANCE';

$insurancecompany = ((isset($quotedata['main_data']['custom_feilds']['proposal_insurance_company'])) && $quotedata['main_data']['custom_feilds']['proposal_insurance_company'] != '') ? strtoupper(strtolower( $quotedata['main_data']['custom_feilds']['proposal_insurance_company'])) : '';

$batteryguard = ((isset($quotedata['main_data']['custom_feilds']['proposal_life_insurance'])) && $quotedata['main_data']['custom_feilds']['proposal_life_insurance'] != '') ?  $quotedata['main_data']['custom_feilds']['proposal_life_insurance'] :0;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-xs-6 secondright px-0 br-0">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4  col-xs-4 br-0">
                                                    <input type="text" class="inputbox olinp" value="<?php echo number_format($batteryguard, 2) ?>" />
                                                </div>
                                                <!-- <div class="col-sm-8 col-xs-8 align-self-center">
                                                    Total VAP
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="rbottom col-xs-12 br-0 px-0">
                                                    ...
                                                    <div class="col-xs-8"><?php echo $insuranceoptions; ?> <?php echo $insuranceType ?> <?php echo $insurancecompany; ?></div>
													...
													<?php if($qfinancialinstitution =='First Bank'){ ?>
													<div class="col-xs-8">POWER PACK</div>
                                                    <div class="col-xs-4 br-0">
                                                        <input type="text" class="inputbox olinp" value="<?php echo number_format($qpowerpack,2); ?>"/>
                                                    </div>
													<?php } ?>
