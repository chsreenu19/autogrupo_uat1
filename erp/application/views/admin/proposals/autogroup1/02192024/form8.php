                        ...
                        <div class="print_block" id="print_block">
                            ...
                            <div class="bodycontent">
                                <div class="row" style="align-items: end;">
                                    <div class="col-xs-12">
                                        <div class="flexdiv">
                                            <p> Fecha: <input type="text" class="inputbox fr1i1" /></p>
                                        </div>

                                    </div>
                                </div>
                                <p>YO <input type="text" class="inputbox" /> hago constar que he entregado a AutoGrupo, en calidad de pronto pago (trade-in), el vehículo de motor marca
                                    <input type="text" class="inputbox" />
                                    modelo <input type="text" class="inputbox" />
                                    con tabilla núm <input type="text" class="inputbox" />
                                    número de serie <input type="text" class="inputbox" />
