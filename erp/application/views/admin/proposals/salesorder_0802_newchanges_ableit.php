...
$PagodeContado = isset($quotedata['main_data']['custom_feilds']['proposal_down_payment']) ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_down_payment']) : '0.00';
        ...
        <table style="width: 100%; background-color: transparent;">
          ...
          <tbody>
			...
			<tr>
			  ...
			  <td colspan="2" style="text-align: right;"><input value="<?php echo $PagodeContado; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  Trade-In
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo isset($quotedata['main_data']['custom_feilds']['proposal_tradein']) ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_tradein']) : '$0'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  Total Credit
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="" placeholder="" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			   <tr>
			...
			<tr>
			  ...
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_payment_plan']) && $quotedata['main_data']['custom_feilds']['proposal_payment_plan']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_payment_plan']) : '$0'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			  <tr>
              <td colspan="2" style="padding-left:15px">
			  Dimond Ceramic
			  </td>
			  <td colspan="2" style="text-align: right;"><input value="<?php echo (isset($quotedata['main_data']['custom_feilds']['proposal_credit_total_2']) && $quotedata['main_data']['custom_feilds']['proposal_credit_total_2']!='') ? '$'.number_format($quotedata['main_data']['custom_feilds']['proposal_credit_total_2']) : '$0'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
			  </tr>
			   <tr>
              <td colspan="2"><strong>Total VAP</strong></td>
              <td colspan="2" class="input-bold" style="text-align: right;"><input value="<?php echo isset($quotedata['main_data']['inventory']['rate']) ? '$'.number_format($quotedata['main_data']['inventory']['rate']) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
            </tr>
			<tr>
              <td colspan="2" style="padding-left:15px">
			 Insurance
              ...
              <td colspan="2" class="input-bold" style="text-align: right;font-weight:600;"><input value="<?php echo isset($quotedata['main_data']['inventory']['rate']) ? '$'.number_format($quotedata['main_data']['inventory']['rate']) : '$0.00'; ?>" placeholder="enter precio unidad" name="PRECIO_UNIDAD" type="text" value=""></td>
            </tr>
           <!-- <tr>
