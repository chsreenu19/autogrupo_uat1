...
<?php
$background_colors = array('#ffffff');

$rand_background = $background_colors[array_rand($background_colors)];
$i=1;
foreach($backsalescat as $bck){
?> 

<!--<div class="quick-stats-invoices col-md-3">
	<div class="top_stats_wrapper min-height-85" style="background: <?php echo $rand_background ;?> !important; color: #000 !important;">
		<a class="text-warning  mbot15">
			</a><p class="text-uppercase mtop5 min-height-35"><a class="text-warning  mbot15"><?php echo $bck['name']; ?></a>
			</p>
			
			<span class="pull-center bold no-mtop font-size-24">
            <?php 
				echo app_format_money($bck['tot'], ($bck['tot'] != 0 ? '$'.get_currency($bck['tot']) : $baseCurrency));
