...
class Apiint extends ApiController
{
	...
	function esignature($data){
		...
		$customerName = isset($data['quotedata']['proposal_to']) ? $data['quotedata']['proposal_to']:'';
		$array = array();
		...
		$array['pago_multas']['marca'] = isset($data['quoteinventory']['Brand']) ? $data['quoteinventory']['Brand']:'';		
		$array['pago_multas']['modelo'] = isset($data['quoteinventory']['Model']) ? $data['quoteinventory']['Model']:'';	
		$array['pago_multas']['anio'] = isset($data['quoteinventory']['Mileage']) ? $data['quoteinventory']['Mileage']:'';	
		$array['pago_multas']['tablilla'] = isset($data['quoteinventory']['Tablilla']) ? $data['quoteinventory']['Tablilla']:'';		
		$array['pago_multas']['num_serie'] = isset($data['quoteinventory']['VIN']) ? $data['quoteinventory']['VIN']:'';	
		...
		$array['recibo_pago_pronto']['recibido_de'] = '';	
		$array['recibo_pago_pronto']['cantidad'] = '';	
		$array['recibo_pago_pronto']['compra_del'] = '';	
		$array['recibo_pago_pronto']['concepto'] = '';	
