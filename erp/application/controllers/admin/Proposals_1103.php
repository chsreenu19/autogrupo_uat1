...
class Proposals extends AdminController
{
	...
	public function getallquotedetails($quoteId){
		...
		$quotedata['quotedata'] = json_decode($result,true);
		curl_close($ch);
       // echo "<pre>"; print_r($quotedata['quotedata']);
	...
	//volant forms
    public function aliquidateaccounts(){
    ...
    public function relayresponsibility(){
    ...
    public function premiumreturnnotearned(){
    ...
    public function promissorysheet(){
    ...
    public function vehiclewarranties(){
    ...
    public function deliveryagreement(){
    ...
    public function annexpurchaseorder(){
