...
class Commissionsreport extends AdminController
{
    ...
    public function list_proposals($proposal_id = '')
    {
        ...
        if ($isPipeline && !$this->input->get('status')) {
            ...
            $data['title']                 = _l('Commission Report');
            ...
            $this->load->view('admin/commissionsreport/manage', $data);
        }
    }
    ...
    public function table()
    {
        ...
        $this->app->get_table_data('commissionsreport');
    }



    public function csummarytable()
    {
        if (
            !has_permission('proposals', '', 'view')
            && !has_permission('proposals', '', 'view_own')
        ...
        $this->app->get_table_data('commissionsreportsummary');
    }
