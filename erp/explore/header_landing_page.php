			...
			<div class="row">
				<div class="col-md-3 col-sm-12 col-xs-12 logo_block">
					<div class="logo_support_div">
						<div class="logo">
							<a href="<?php echo BASE_URL.'inventory.php'; ?>"><img src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $logo; ?>" alt=""></a>
						</div>
				...
				<div class="col-md-8 col-sm-9 pl-0">
					<div class="menu">
						<ul id="nav" class="main-menu">
							...
							?>
							<!--<li><a href="#" tru-link="prequal" click-type="menu" > Quick Pre-Qualify </a></li>-->
						</ul>
					</div>
				</div>
			</div>
