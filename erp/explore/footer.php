		...
		<div class="container">
			...
			<div class="row">
				<div class="copyright col-md-12">
					<p><?php echo 'Copyright '. date("Y").' '.  $footer_copyright; ?></p>
				</div>
			</div>
		</div>
	</div>
...
<!--<script id="tru-script" async src="https://client.trupayments.com/api.js?v=1&dealer-key=100047648"></script>-->
	<!--Js-->
	...
	<script src="<?php echo BASE_URL; ?>assets/js/jquery.showLoading.js"></script>
	  <script src='<?php echo BASE_URL; ?>assets/js/jquery.magnific-popup.js'></script>
	        <script src="//labels-prod.s3.amazonaws.com/vin_select/129784.js"></script>
