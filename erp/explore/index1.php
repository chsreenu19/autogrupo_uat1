			...
			<a href="#">
				<div class="card cat_card">
					...
					<div class="cat_text">
						...
						<a  href="#" class="cat_see_more">See More <span class="far fa-angle-right"></span></a>
					</div>
				</div>
			</a>
		</div>
						...
						// Check if this seller is active or inactive
							...
							if($valid == 1):
								...
								<div class="featured-item">
									<div class="featured-photo" style="background-image: url(<?php echo BASE_URL.'assets/uploads/cars/'.$row['featured_photo']; ?>)">
