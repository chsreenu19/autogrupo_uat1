			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					...
					<div class="col-md-12 col-sm-12">
						<h5>Busca tu auto Semi - Nuevo</h5>
						<h3 style="text-align:center;">ÚNICO DEALER ABIERTO 24 HORAS 7 DIAS A LA SEMANA</h3><br/>
					</div>
				...
				<div class="col-md-6 col-sm-12">
					<div class="card">
						<div class="row">
							<div class="col-md-12">
								<iframe width="600" height="850" src="http://localhost/crm/forms/wtl/0c538025b2273d7ec292b4397d413ecc" frameborder="0" allowfullscreen></iframe>
								<?php
...
<?php if($page_layout == 'Custom Contact'): ?>
	<?php
	$statement = $pdo->prepare("SELECT * FROM tbl_settings WHERE id=1");
	$statement->execute();
	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
