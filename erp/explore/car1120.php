			...
			<div class="col-md-3 col-sm-12">
				<div class="car-detail-sidebar">
					<ul class="car-main-tab">
						<li class="active"><a href="#Contact" data-toggle="tab" aria-expanded="true">Contact</a></li>
						<li class=""><a href="#Car_Details" data-toggle="tab" aria-expanded="true">Car Details</a></li>
					</ul>
...
<div class="tab-pane " id="Car_Details">
...
?>
			...
			<div class="detail-item car-detail-list border-0 br-4 img-rounded mt-4">
				<div class=" border p-3">
					...
					<div class="row Mortgage_form">
						<div class="col-md-12">
							<input type="text" class=" mb-3" name="" placeholder="50000">
						</div>
						<div class="col-md-12">
							<input type="text" class=" mb-3" name="" placeholder="5">
						</div>
						<div class="col-md-12">
							<input type="text" class=" mb-3" name="" placeholder="Down Payment">
						</div>
						<div class="col-md-12">
							<input type="text" class=" mb-3" name="" placeholder="5">
						</div>
						<div class="col-md-12">
							<div class="mb-3 Mortgage_vlaues"><span>$</span>&nbsp; 0</div>
						</div>
						<div class="col-md-12">
							<div class="mb-3 Mortgage_vlaues"><span>$</span>&nbsp; 0</div>
						</div>
						<div class="col-md-12">
							<input type="submit" value="Calculate" class="btn-theme" id="submitbtn" name="form1">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-md-9 col-sm-12">
			<div class="car-detail-mainbar">
				...
				<div id="sync1" class="slider owl-carousel car-detail-gallery">

					<?php 
					if($featured_photo!=''){
						?>
						<div class="car-detail-photo item" style="background-image: url(<?php echo BASE_URL; ?>assets/uploads/cars/<?php echo $featured_photo; ?>)">
					...
					<?php }else{ echo '<h3 style="text-align:center;">No images found</h3>';} ?>
					...
					foreach ($result as $row) {
						...
						<div class="car-detail-photo item" style="background-image: url(<?php echo BASE_URL; ?>assets/uploads/other-cars/<?php echo $row['photo']; ?>)">
							<div class="lightbox-item">
				...
				<div id="sync2" class="navigation-thumbs owl-carousel">
					...
					if($featured_photo!=''){
						?>
						<div class="car-detail-photo item" style="background-size : 100% 100%; background-repeat: no-repeat; background-position: bottom center;background-image: url(<?php echo BASE_URL; ?>assets/uploads/cars/<?php echo $featured_photo; ?>); ">
							<div class="lightbox-item ">
								<a href="<?php echo BASE_URL; ?>assets/uploads/cars/<?php echo $featured_photo; ?>" data-lightbox="lightbox-item"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					...
					foreach ($result as $row) {
						...
						<div class="car-detail-photo item" style="background-size : 100% 100%; background-repeat: no-repeat; background-position: bottom center;background-image: url(<?php echo BASE_URL; ?>assets/uploads/other-cars/<?php echo $row['photo']; ?>); ">
							<div class="lightbox-item ">
								<a href="<?php echo BASE_URL; ?>assets/uploads/other-cars/<?php echo $row['photo']; ?>" data-lightbox="lightbox-item"><i class="fa fa-search-plus"></i></a>
							</div>
						</div>
					...
					<?php if($car_condition!='Rentals'){ ?>

						<div class="related-ads" style="margin-top: 0px !important; text-align:center;">
							<div class="related-ads-headline">
								<h2><a href="calculator/index.html" target="_blank"><img src="assets/images/calculator.png" style="width:60%;"/></a></h2>
							</div>

							<!--<iframe src="calculator/index.html" title="description" height="970" width="900"></iframe>-->
							<?php //require_once 'calculator/index.html'; ?>
						</div>
					<?php } ?>
									...
									<div class=" listing-item">
										<div class="row ">
											<div class="col-md-6 col-sm-6 col-xs-12 listing-photo">
												<img src="<?php echo BASE_URL; ?>assets/uploads/cars/<?php echo $row['featured_photo']; ?>">
												<h2>
