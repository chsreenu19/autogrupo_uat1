...
foreach ($result as $row) {
	...
	$carfax_icon=$row['carfax_icon_url'];
}
					...
					<div class="detail-item car-detail-form">
						<div class="tab-content car-content">
							...
							<!--<div style="text-align:right !important;">
								<div href="#" tru-vehicle vin="<?php echo $vin; ?>" dealer-key="100047648" button-mode="SRP"> </div>
							</div>-->
...
?>
			...
			<div class="detail-item car-detail-list border-0 br-4 img-rounded mt-4">
				<div class="p-3">
					<h3 class="side_strip border-bottom mt-3 pb-2">Loan Calculator</h3>
					<div class="row Mortgage_form">
						<div class="col-md-12">
						<h4>Vehicle Cost: $<?php echo number_format($sale_price); ?></h4>
							<input type="hidden" class=" mb-3" name="custom_fields[proposal][18]" value="<?php echo $sale_price; ?>" placeholder="Vehicle Cost" name="custom_fields[proposal][18]">
						</div>
						<div class="col-md-12">
...
<div class="car-detail-mainbar">
			...
			<div class="gallery-slider_wrapper">
				<div class="single-gallery-carousel-content-box owl-carousel owl-theme">
					...
					$fileL = '';		
					if($featured_photo!='' && file_exists(D_ROOT.$featured_photo)){
						
						$fileL = BASE_URL.'assets/uploads/cars/'.$featured_photo;
					}else{
					...
					//if($featured_photo!=''){
					?>
					<a class="item car_slider" href="<?php echo $fileL; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
						<img src="<?php echo $fileL; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Awesome Image"/>
					</a>
					<?php //} ?>
				...
				<div style="margin:10px 25px 0 25px;">
					<div class="single-gallery-carousel-thumbnail-box owl-carousel owl-theme">
						...
						<div class="item gfhhkj" href="<?php echo BASE_URL; ?>assets/uploads/other-cars/<?php echo $row['photo']; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
							<img src="<?php echo BASE_URL; ?>assets/uploads/other-cars/<?php echo $row['photo']; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Awesome Image"/>
						</div>
						<?php 
						}
								...
								<div class="car-tab-text">
									...
									if($car_condition!='Rentals' && $vin !=''){
										...
										<p style="text-align: center;">
											...
											<a href="<?php echo $carfax_url; ?>" target="_blank">
												
												<img style="height:100px;" src="<?php echo $carfax_icon; ?>"/>
												<?php //echo $vin; ?>
											</a>
												<span class="monroney-labels" data-year="<?php echo $year; ?>" data-make="<?php echo ucfirst($brand_name); ?>" data-vin="<?php echo $vin; ?>" data-vendor-id="auto1pr"></span>
						...
						if($total):
							foreach ($result as $row) {
								...
								<?php
									...
									$fileL = '';		
									if($row['featured_photo']!='' && file_exists(D_ROOT.$row['featured_photo'])){
	...
	src="https://assets.dealerimagepro.com/v3/auto1.js"
	data-dealer="2544"
...
.tru-banner-slide.left:hover {
	...
	.single-gallery-carousel-content-box.owl-carousel.owl-theme.owl-loaded.owl-drag .owl-item img {
		display: block;
		width: auto;
	...
	*/
			...
			$("body").on("click","#submitbtn",function(e){
				...
				if($('#from_date').val() !='' && $('#to_date').val()!='' && $("#visitor_name").val() !=='' && $("#visitor_email").val() !=='' && $("#visitor_phone").val() !=='' && $("#visitor_message").val() !==''){
					...
					$.ajax({
						type:'get',
						url: 'https://dealerpadpr.com/auto1/apis/node/services/call/createlead',
						data:str,
