...
?>
			...
			<div class="detail-item car-detail-list border-0 br-4 img-rounded mt-4">
				<div class="p-3">
					<h3 class="side_strip border-bottom mt-3 pb-2">Vehicle Finance</h3>
					<p style="text-align: center;"><a href="calculator/index.html" target="blank">click here for calculator</a></p>
