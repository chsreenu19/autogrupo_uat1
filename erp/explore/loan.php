...
<form name="loandata" method="post" action="">
    <table id="emi" width="100%">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="principal" value="<?php echo isset($principle) ? $principle : ''; ?>" >
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="interest" value="<?php echo isset($iRate) ? $iRate : ''; ?>">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="years" value="<?php echo isset($term1) ? $term1 : ''; ?>">
            </td>
        ...
        <tr>
            ...
            <td>
                <input autocomplete="off" type="text" name="start_date" size="12" id="start_date">
            </td>
        </tr>
		...
		<tr>
            ...
            <td>
                <input type="text" name="downpayment" value="<?php echo isset($downpayment) ? $downpayment : ''; ?>">
            </td>
        </tr>
		...
		<tr>
            ...
            <td>
               <input type="text" name="tradein" value="<?php echo isset($tradein) ? $tradein : ''; ?>">
            </td>
        </tr>
        <tr style="text-align: center;">
            <td colspan="3">
                <input style="width: 15% !important;" type="submit" value="Compute"  name="EMI_submit" class="btn btn-primary">
            </td>
        </tr>
    </table>
</form>
