<?php require_once('header1119.php'); ?>
...
<div class="car-detail-mainbar">
			...
			<div class="gallery-slider_wrapper">
				<div class="single-gallery-carousel-content-box owl-carousel owl-theme">
					...
					if($featured_photo!=''){
					?>
					<a class="item" href="<?php echo BASE_URL; ?>assets/uploads/cars/<?php echo $featured_photo; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
					...
					<a class="item" href="<?php echo BASE_URL; ?>assets/uploads/other-cars/<?php echo $row['photo']; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
					...
					<!--<a class="item" href="https://images.pexels.com/photos/631986/pexels-photo-631986.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
						<img src="https://images.pexels.com/photos/631986/pexels-photo-631986.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Awesome Image"/>
					</a>
					<a class="item" href="https://images.pexels.com/photos/631986/pexels-photo-631986.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
						<img src="https://images.pexels.com/photos/631986/pexels-photo-631986.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Awesome Image"/>
					</a>
				...
				<div style="margin:10px 25px 0 25px;">
					<div class="single-gallery-carousel-thumbnail-box owl-carousel owl-theme">
						...
						<div class="item" href="<?php echo BASE_URL; ?>assets/uploads/cars/<?php echo $featured_photo; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
							<img src="<?php echo BASE_URL; ?>assets/uploads/cars/<?php echo $featured_photo; ?>?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Awesome Image"/>
						</div>
						<?php } ?>
	...
	<?php require_once('footer1119.php'); ?>
