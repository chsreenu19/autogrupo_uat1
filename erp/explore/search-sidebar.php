...
<form action="<?php echo BASE_URL; ?>check-get.php" method="get">
	...
	<div class="widget-item">
		...
		<select data-placeholder="Choose Brand" class="form-control brand" name="brand_id" onchange="this.form.submit()">
			...
			foreach ($result as $row) {
				?>			
				<option value="<?php echo $row['brand_id']; ?>" <?php if(isset($_GET['brand_id']))  {if($_GET['brand_id']==$row['brand_id']) {echo 'selected';}} ?>><?php echo ucwords(strtolower($row['brand_name'])); ?></option>
				<?php
			}
			?>
		</select>
	...
	<div class="widget-item">
		...
		<?php else: ?>
			<select data-placeholder="Choose Model" class="form-control chosen-select" name="model_id" onchange="this.form.submit()">
				...
				foreach ($result as $row) {
					?>			
					<option value="<?php echo $row['model_id']; ?>" <?php if(isset($_GET['model_id']))  {if($_GET['model_id']==$row['model_id']) {echo 'selected';}} ?>><?php echo ucwords(strtolower($row['model_name'])); ?></option>
					<?php
				}
				?>
			</select>
	...
	<div class="widget-item">
		...
		<select data-placeholder="Choose Condition" class="form-control chosen-select" name="car_condition" onchange="this.form.submit()">
			...
			<option value="Used Car" <?php if(isset($_GET['car_condition']))  {if($_GET['car_condition']=='Used Car') {echo 'selected';}} ?>>Used Car</option>
		</select>
	</div>
...
<div class="widget-item ">
	...
	<div class=" row align-items-center">
		<div class="col-md-5 input_icon cal">
			<input autocomplete="off" type="text" class="form-control" name="mileage_start"  placeholder="From" value="<?php if(isset($_GET['mileage_start'])) { echo $_GET['mileage_start'];} ?>"> 
		</div>
		<div class="col-md-1">-</div>
		<div class="col-md-5 input_icon cal">

			<input autocomplete="off" type="text" class="form-control" name="mileage_end" placeholder="To" value="<?php if(isset($_GET['mileage_end'])) { echo $_GET['mileage_end'];} ?>">
		</div>
	</div>
</div> -->
...
<div class="widget-item" >
	...
	<div class=" row align-items-center">
		<div class="col-md-5 input_icon cal">
			<input autocomplete="off" type="text" class="form-control" name="year_id" id="year_id"  placeholder="From" value="<?php if(isset($_GET['year'])) { echo $_GET['year'];} ?>"> 
		</div>
		<div class="col-md-1">-</div>
		<div class="col-md-5 input_icon cal">
			<input autocomplete="off" type="text" class="form-control" name="to_year_id" id="to_year_id"  placeholder="To" value="<?php if(isset($_GET['to_year'])) { echo $_GET['to_year'];} ?>">
		</div>
	</div>
</div>
...
<div class="result-button">
	<input type="submit" value="Search" class="btn" name="form_sidebar">
</div>
