									...
									<form accept="<?php echo BASE_URL.URL_PAGE.$_REQUEST['slug']; ?>" method="post">
										<div class=" row">
											...
											<div class="form-group col-md-6 col-sm-12">
												...
												<input type="text" class="form-control" name="SocialSecurity" placeholder="SocialSecurity">
											</div>
											...
											<div class="form-group col-md-6 col-sm-12">
												...
												<input type="text" class="form-control" name="Residence Time" placeholder="Residence Time">
											</div>
											...
											<div class="form-group col-md-6 col-sm-12">
												...
												<input type="text" class="form-control" name="Employment time" placeholder="Employment time">
											</div>
											<div class="form-group col-md-6 col-sm-12">
												<label for="">Entry</label>
												<input type="text" class="form-control" name="Entry" placeholder="Entry">
											</div>
												<div class="form-group col-md-6 col-sm-12">
    				...
    				<div class=" listing-item">
    					<div class="row">
    						<div class="col-md-6 col-sm-12 col-xs-12 listing-photo" style="background-image: url()">
    							<img src="<?php echo BASE_URL.'assets/images/car_sample.svg'.$row['car_sample.svg']; ?>">
    							<h2>
    								<?php if($row['regular_price']!=$row['sale_price']): ?>
    									<del>$<?php echo $row['regular_price']; ?></del>
    									$<?php echo $row['sale_price']; ?>
