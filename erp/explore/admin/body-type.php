...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Body Types</h1>
	</div>
	<div class="content-header-right">
		<a href="body-type-add.php" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
                	...
                	foreach ($result as $row) {
    	                ...
    	                <tr>
    	                    ...
    	                    <td>
    	                        ...
    	                        <a href="#" class="btn btn-danger btn-xs" data-href="body-type-delete.php?id=<?php echo $row['body_type_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
    	                    </td>
    	                </tr>
    	                <?php
                	}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                Be Careful! All car under this body type will be deleted also.
            </div>
