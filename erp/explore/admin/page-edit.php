                ...
                <div class="form-group">
					...
					<div class="col-sm-2">
						<select class="form-control select2" name="page_layout" style="width:300px;" onchange="showContentInputArea(this)">
							...
							<option value="New Car Page Layout" <?php if($page_layout=='New Car Page Layout') {echo 'selected';} ?>>New Car Page Layout</option>
							<option value="Old Car Page Layout" <?php if($page_layout=='Old Car Page Layout') {echo 'selected';} ?>>Old Car Page Layout</option>
							...
							<option value="Rentals" <?php if($page_layout=='Rentals') {echo 'selected';} ?>>Rentals</option>
						</select>
					</div>
				</div>
