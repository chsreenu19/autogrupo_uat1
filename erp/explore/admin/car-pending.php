...
<section class="content-header">
	<div class="content-header-left">
		<h1>View All Pending Cars</h1>
	</div>
	<div class="content-header-right">
		<a href="car-approved.php" class="btn btn-primary btn-sm">Approved Cars</a>
	</div>
</section>
                ...
                foreach ($result as $row) {
	                ...
	                <tr>
	                    ...
	                    <td>
                            ...
                            <a href="#" class="btn btn-warning btn-xs" data-href="car-pending-action.php?id=<?php echo $row['car_id']; ?>" data-toggle="modal" data-target="#confirm-approve">Approve it</a>
