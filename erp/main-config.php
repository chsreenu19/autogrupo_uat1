...
define('CLIENT_MAIN_URL', "http://".$_SERVER['HTTP_HOST'].str_replace( str_replace("\\", "/", $_SERVER['DOCUMENT_ROOT']), '', str_replace("\\", "/", str_replace(MSELF, '', MFCPATH))));
...
//CRM
define('CRM_DB', 'autogroup_uat1');
define('CRM_DB_HOST', 'localhost');
define('CRM_DB_USERNAME', 'root');
define('CRM_DB_PASSWORD', '');


//ecommerce DB details
define('EXPLORE_DB', 'rapid1y6_upgraded_rentals_jchp');
define('EXPLORE_DB_HOST', 'localhost');
define('EXPLORE_DB_USERNAME', 'root');
define('EXPLORE_DB_PASSWORD', '');
